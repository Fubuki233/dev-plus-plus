---
description: "dev++: validate YAML UI stories with Playwright screenshots"
argument-hint: "[headed] [filename-filter] [vision]"
---

Use `$ui-story-validation` and `$playwright-ui-automation` to validate UI stories from YAML files.
